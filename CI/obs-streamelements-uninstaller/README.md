# obs-streamelements-uninstaller
OBS.Live uninstaller

# Release procedure

* Build obs-streamelements-uninstaller.exe
* Sign obs-streamelements-uninstaller.exe with the code signing EV token on a sterile machine
...
Once obs-streamelements-uninstaller.exe is built and signed, check that it's completely clean with the following online scanners:
