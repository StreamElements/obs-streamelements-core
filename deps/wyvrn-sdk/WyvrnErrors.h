...
//! \file WyvrnErrors.h
//! \brief Error codes for Wyvrn SDK. If the error is not defined here, refer to WinError.h from the Windows SDK.

#ifndef _WYVRN_ERRORS_H_
#define _WYVRN_ERRORS_H_
