...
| [`setRazerWyvrnEvent(RazerWyvrnEventInfo, ResultCallback<success>)`](host/razer-wyvrn.md#setrazerwyvrneventrazerwyvrneventinfo-resultcallbacksuccess) | [Razer WYVRN](host/razer-wyvrn.md) |
