...
## `getAvailableTransitionClasses(ResultCallback<TransitionInfo[]>)`

Get available transition classes (types).
...
Show properties dialog for the root transition of the video composition referenced by *videoCompositionId*.
