...
struct qt_meta_stringdata_QCefWidget_t {
    QByteArrayData data[6];
    char stringdata0[46];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QCefWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QCefWidget_t qt_meta_stringdata_QCefWidget = {
    {
QT_MOC_LITERAL(0, 0, 10), // "QCefWidget"
QT_MOC_LITERAL(1, 11, 12), // "titleChanged"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 5), // "title"
QT_MOC_LITERAL(4, 31, 10), // "urlChanged"
QT_MOC_LITERAL(5, 42, 3) // "url"

    },
    "QCefWidget\0titleChanged\0\0title\0"
    "urlChanged\0url"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_QCefWidget[] = {
...
void QCefWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QCefWidget::titleChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QCefWidget::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QCefWidget::urlChanged)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QCefWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_QCefWidget.data,
    qt_meta_data_QCefWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *QCefWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QCefWidget.stringdata0))
