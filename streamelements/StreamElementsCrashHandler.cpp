...
static inline void AddObsConfigurationFiles()
{
	...
	std::vector<std::wstring> blacklist = {
		...
		L"plugin_config/obs-streamelements-core/cache/",
		L"plugin_config/obs-streamelements-core/blob_storage/",
		L"plugin_config/obs-streamelements-core/code cache/",
		L"plugin_config/obs-streamelements-core/gpucache/",
		L"plugin_config/obs-streamelements-core/visited links/",
		L"plugin_config/obs-streamelements-core/transportsecurity/",
		L"plugin_config/obs-streamelements-core/videodecodestats/",
		L"plugin_config/obs-streamelements-core/session storage/",
		L"plugin_config/obs-streamelements-core/service worker/",
		L"plugin_config/obs-streamelements-core/pepper data/",
		L"plugin_config/obs-streamelements-core/indexeddb/",
		L"plugin_config/obs-streamelements-core/file system/",
		L"plugin_config/obs-streamelements-core/databases/",
		L"plugin_config/obs-streamelements-core/obs-streamelements-core.ini.bak",
		L"plugin_config/obs-streamelements-core/cef.",
		L"plugin_config/obs-streamelements-core/obs_profile_cookies/",
		L"plugin_config/obs-streamelements-core/crashes/",
		L"updates/",
		L"profiler_data/",
		L"obslive_restored_files/",
		L"plugin_config/obs-browser/streamelements_restored_files/",
		L"plugin_config/obs-streamelements-core/streamelements_restored_files/",
		L"crashes/"};
